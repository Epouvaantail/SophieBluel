...
Front-end developer of a team working on the design of an interior designer's portfolio site.
Missions: 
...
- The modal allowing to upload new media (code to be created from scratch).
